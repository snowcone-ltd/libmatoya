...
static bool memory_printf(void)
{
	...
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%-0d", 42), "42");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%-0d", -42), "-42");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%-05d", 42), "42   ");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%-05d", -42), "-42  ");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%-015d", 42), "42             ");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%-015d", -42), "-42            ");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%0-d", 42), "42");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%0-d", -42), "-42");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%0-5d", 42), "42   ");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%0-5d", -42), "-42  ");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%0-15d", 42), "42             ");
	test_specific_printf("MTY_SprintfD", MTY_SprintfD("%0-15d", -42), "-42            ");
