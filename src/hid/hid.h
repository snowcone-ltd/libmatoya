...
typedef void (*HID_KEY_VALUE)(uint32_t usage, bool down, void *opaque);

struct hid *mty_hid_create(HID_CONNECT connect, HID_DISCONNECT disconnect, HID_REPORT report, HID_KEY_VALUE value, void *opaque);
